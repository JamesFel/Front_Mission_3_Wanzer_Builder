...
function HandWeapon(name, cost, weight, dmg, apCost, acc, rangeMin, rangeMax,
    weaponType, dmgType, numHits, accLoss)
{
    ...
    this.avgDmg = this.totalDmg * (this.acc - this.accLoss * (this.rangeMax -
        this.rangeMin) / 2) / 100;
}
